...
def run_instruction(line: str, stacks: list[list[str]]) -> None:
    ...
    for i in range(number_of_blocks):
        movedBlock = stacks[source_stack - 1].popleft()
        stacks[destination_stack - 1].extendleft(movedBlock)
...
if __name__ == "__main__":
    with open("inputs/day5-1.txt") as file:
        ...
        with open("outputs/day5-1.txt", "w") as file:
